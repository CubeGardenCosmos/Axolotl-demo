; =============================================================================
; 《Axolotl 演示 · 主角 Sion》 — 音乐混音台（.axaudiomix 分轨编曲）
;
...
; ======================================================================
Sion:混音台测试台已就位——选一组轨道试听。换轨不会打断播放，只有 bgm:none 才让整台淡出停下。 -Vbeep_heroine.wav;
...
Sion:钢琴和弦打底、竖琴琶音铺开——1、2 号轨。换轨不打断，音乐继续。 -Vbeep_heroine.wav;
jumpLabel:test_menu;

label:t23;
bgm:bgm/fairy_dance_mix.axaudiomix -track=2,3;
Sion:竖琴织体、小提琴旋律进入——2、3 号轨。 -Vbeep_heroine.wav;
jumpLabel:test_menu;

label:t13;
bgm:bgm/fairy_dance_mix.axaudiomix -track=1,3;
Sion:钢琴 + 小提琴、竖琴静音——1、3 号轨。 -Vbeep_heroine.wav;
jumpLabel:test_menu;

label:t1;
bgm:bgm/fairy_dance_mix.axaudiomix -track 1;
Sion:独奏：只剩 1 号钢琴。 -Vbeep_heroine.wav;
jumpLabel:test_menu;

label:t2;
bgm:bgm/fairy_dance_mix.axaudiomix -track 2;
Sion:独奏：2 号竖琴（空格写法 -track 2）。 -Vbeep_heroine.wav;
jumpLabel:test_menu;

label:t3;
bgm:bgm/fairy_dance_mix.axaudiomix -track=3;
Sion:独奏：3 号小提琴。 -Vbeep_heroine.wav;
jumpLabel:test_menu;

label:mute;
bgm:none;
Sion:bgm:none——整台一起淡出停下。这是唯一停止播放的方式；之后再起 bgm 才会重新播放。 -Vbeep_heroine.wav;
jumpLabel:test_menu;

label:mono;
bgm:bgm/fairy_dance_mono.wav -volume=55 -enter=800;
Sion:单声道单曲：45 秒剪辑作为普通 BGM 一切照常（混音台轨道仍要求双声道）。 -Vbeep_heroine.wav;
jumpLabel:test_menu;

label:hall;
Sion:音频巡礼到此为止，我们回大厅继续。 -Vbeep_heroine.wav;
...
bgm:bgm/fairy_dance_mix.axaudiomix -track=1,2;
Sion:钢琴和弦打底、竖琴琶音铺开——只有 1、2 号轨在响。 -Vbeep_heroine.wav;

:『换轨』切到 2+3——注意音乐没有从头开始，只是通道切换。;
bgm:bgm/fairy_dance_mix.axaudiomix -track=2,3;
Sion:竖琴织体、小提琴旋律进入——2、3 号轨，播放位置原样继续。 -Vbeep_heroine.wav;

:『换轨』再切 1+3——2 号轨静音、1 号轨回来，仍然不重播。;
bgm:bgm/fairy_dance_mix.axaudiomix -track=1,3;
Sion:再来一组配器变化：钢琴 + 小提琴，1、3 号轨。 -Vbeep_heroine.wav;

:『bgm:none』整台淡出——这是唯一停止播放的方式。;
bgm:none;
Sion:bgm:none 让整个混音台一起淡出。 -Vbeep_heroine.wav;

:『重新起播』只有 bgm:none 之后，再次 bgm:<mix> 才会从头开始。;
bgm:bgm/fairy_dance_mix.axaudiomix -track 1;
Sion:独奏重启：钢琴从头上起——换轨不重播、bgm:none 之后才重播。 -Vbeep_heroine.wav;

:『单声道素材』普通单曲可放单声道；混音台轨道仍要求双声道。;
bgm:none;
bgm:bgm/fairy_dance_mono.wav -volume=55 -enter=800;
Sion:这是从钢琴 stem 下混的 45 秒单声道剪辑——作为普通 BGM 一切照常。 -Vbeep_heroine.wav;
...
label:to_logic;
Sion:混音台展示结束，自动进入下一章「Live2D 角色演出」。 -Vbeep_heroine.wav;
